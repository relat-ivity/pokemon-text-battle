...
class GameDataCache:
    ...
    def _load_all_data(self):
        ...
        try:
            with open("./pokechamp-ai/poke_env/data/static/moves/moves_effect.json", "r") as f:
        ...
        try:
            with open("./pokechamp-ai/poke_env/data/static/moves/gen8pokemon_move_dict.json", "r") as f:
        ...
        try:
            with open("./pokechamp-ai/poke_env/data/static/abilities/ability_effect.json", "r") as f:
        ...
        try:
            with open("./pokechamp-ai/poke_env/data/static/abilities/gen8pokemon_ability_dict.json", "r") as f:
        ...
        # Item effects
        try:
            with open("./pokechamp-ai/poke_env/data/static/items/item_effect.json", "r") as f:
    ...
    def get_pokedex(self, gen: int) -> Dict[str, Any]:
        ...
        if cache_key not in self._data:
            try:
                with open(f"./pokechamp-ai/poke_env/data/static/pokedex/gen{gen}pokedex.json", "r") as f:
